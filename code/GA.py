...
def get_data(path_data):
    # path_data = 'Data/15points_1day.txt'
...
class Population:
    ...
    def crossover(self, ind1, ind2):
        ...
        cxpoint1 = rd.randint(0, size)
        cxpoint2 = rd.randint(0, size - 1)
...
def main():
    ...
    for path in path_data:
        ...
        for i in range(63, 100):
            ...
            write_file(res_path, "*******************************\n")
            write_file(res_path, f'Lan thu {i}\n')
            write_file(res_path, f'best tour: {best_indivi.tour}\n')
            write_file(res_path, f'cost: {best_indivi.cost_of_tour}; so loi: {best_indivi.invalid_coef}\n')
            write_file(res_path, f'fitness: {ga_population.comp(best_indivi)}\n')
            write_file(res_path, f'Thoi gian chay: {end - start}\n')

...
class model():
    def __init__(self, seed=42, percent_print=0.5) -> None:
    ...
    def render_history(self, shape: Tuple[int, int] = None, min_cost=1e-6, title="", yscale=None,
                       ylim: list[float, float] = None, re_fig=False):
        if shape is None:
